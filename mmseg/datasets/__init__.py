...
from .cityscapes import CityscapesDataset_road, CityscapesDataset_single_scene, CityscapesDataset_multi_scene
from .kitti_road import KittiRoadDataset
from .camvid_road import CamvidDataset
...
__all__ = [
    ...
    'CityscapesDataset_road', 'KittiRoadDataset', 'CamvidDataset', 
]
