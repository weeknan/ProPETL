...
class BaseDecodeHead(BaseModule, metaclass=ABCMeta):
    ...
    def cls_seg(self, feat):
        """Classify each pixel."""
        # print(feat.shape)
        # torch.save(feat, '/irip/zhounan_2023/Project/RegionAdapter/visualize/transfer/full_last_D.pth')
        # assert False
    ...
    def predict_by_feat(self, seg_logits: Tensor,
        ...
        #print(batch_img_metas[0]['img_shape'], batch_img_metas[1]['img_shape'])
        seg_logits = resize(
            input=seg_logits,
