...
class RoadVisualizer(Visualizer):
    """Local Visualizer.
    ...
    def _draw_sem_seg_gt(self, image: np.ndarray, sem_seg: PixelData,
        ...
        mask[sem_seg[0] == 0, :] = [128, 64, 128]
        mask[sem_seg[0] != 0, :] = image[sem_seg[0] != 0, :]

        mask[sem_seg[0] == 255, :] = 0
    ...
    def add_datasample(
        ...
        if draw_gt and data_sample is not None and 'gt_sem_seg' in data_sample:
            ...
            gt_img_data, ignore_area = self._draw_sem_seg_gt(gt_img_data,
