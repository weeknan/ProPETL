...
from .setr_up_head_count import SETRUPHead_count
from .mlp_head import MLPHead, BNHead, VariableGranularityBNHead, ClsBNHead
from .uper_head_mid_region_cls import UPerHeadMidCls
...
__all__ = [
    ...
    'LightHamHead', 'PIDHead', 'DDRHead', 'SETRUPHead_count', 
    'MLPHead', 
]
