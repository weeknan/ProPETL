...
model = dict(
    ...
    backbone=dict(
        ...
        saved_adapter_ckpt='./work_dirs/swin_l_2xb8_80k_ade-640x640_adaptformer_r24_global_cls/iter_80000.pth',
        ),
...
optim_wrapper = dict(
    ...
    type='OptimWrapper',
    optimizer=dict(
        type='AdamW', lr=0.0003, betas=(0.9, 0.999), weight_decay=0.02),
    paramwise_cfg=dict(
        custom_keys={
